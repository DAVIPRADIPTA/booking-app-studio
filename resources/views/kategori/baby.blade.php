    ...
    <div class="content-wrapper">
        ...
        <div class="content-grid">
            ...
            <div class="pricing-section">
                <img src="{{ asset('images/Bsc_price.jpg') }}" alt="Baby Smash Cake Package Flyer" class="pricing-image" loading="lazy">
            </div>
            ...
            <form id="bookingForm" novalidate>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="babyName" name="babyName" class="form-input" 
                               placeholder="Nama si kecil" required aria-describedby="babyName-error">
                    ...
                    <div class="form-group">
                        ...
                        <select id="babyAge" name="babyAge" class="form-select" required aria-describedby="babyAge-error">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="date" name="date" class="form-input" required aria-describedby="date-error">
                    ...
                    <div class="form-group">
                        ...
                        <select id="time" name="time" class="form-select" required aria-describedby="time-error">
                            ...
                            <option value="late-afternoon">Late Afternoon (15:30 - 17:30)</option>
                        </select>
                ...
                <div class="notes-section">
                    <div class="form-group">
                        ...
                        <div class="form-description">
                            Tulis permintaan khusus, tema yang diinginkan, atau detail lainnya tentang sesi foto bayi Anda
                        </div>
        ...
        <div class="terms-modal-footer">
            <div class="terms-agreement">
                ...
                <label for="termsCheckbox" class="terms-agreement-text">
                    Dengan mencentang Syarat & Ketentuan (Aturan & Perjanjian Booking Baby Smash Cake) Anda dianggap telah membaca dan menyetujui seluruh ketentuan di atas.
                </label>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateWhatsAppMessage(formData) {
        const timeNames = {
            ...
            'late-afternoon': 'Late Afternoon (15:30 - 17:30)'
        };

        ...
        <div class="content-wrapper">
            ...
            <div class="hero-section">
                ...
                <p class="hero-description">
                    Capture Beautiful Moments Together - Create lasting memories with your friends, family, or colleagues
                    through our professional group photography sessions that celebrate your special bonds
                </p>
            </div>
            ...
            <div class="content-grid">
                ...
                <div class="pricing-section">
                    <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Group_price.jpg-lEbtVb2LwzzPvHA7vf8EjrOWgSJ8xQ.jpeg"
                        alt="Group Photography Package Flyer" class="pricing-image" loading="lazy">
                </div>

                {{-- Package Cards Section --}}
                <div class="package-section">
                    {{-- Paket Plain --}}
                    <div class="package-card" data-package="plain" data-price="300000" data-backgrounds data-price="300000"
                        data-backgrounds="1" tabindex="0" role="button" aria-label="Select Plain Package">
                    ...
                    {{-- Paket Grande --}}
                    <div class="package-card" data-package="grande" data-price="500000" data-backgrounds="2" tabindex="0"
                        role="button" aria-label="Select Grande Package">
                        <div class="package-header">
                    ...
                    {{-- Paket Royal --}}
                    <div class="package-card" data-package="royal" data-price="700000" data-backgrounds="4" tabindex="0"
                        role="button" aria-label="Select Royal Package">
                        <div class="package-header">
                ...
                <form id="bookingForm" novalidate>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="groupSize" name="groupSize" class="form-select" required
            ...
            <div class="terms-modal-footer">
                <div class="terms-agreement">
                    ...
                    <label for="termsCheckbox" class="terms-agreement-text">
                        Dengan mencentang Syarat & Ketentuan (Aturan & Perjanjian Booking Group Photography) Anda dianggap
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            extraCheckboxes.forEach(cb => cb.addEventListener('change', function () {
                ...
                if (this.checked) {
                    // Perbaikan: Simpan dalam format yang sesuai dengan yang diharapkan server
                    selectedExtras.push({
                        id,
                        name,
                        unitPrice: price,  // Nama properti disesuaikan
                        qty: 1,            // Tambahkan qty default 1
                        price: price       // Tetap simpan price untuk kompatibilitas
                    });
                } else {
            ...
            function updateTotalPrice() {
                // Perbaikan: Hitung berdasarkan unitPrice * qty
                const extrasTotal = selectedExtras.reduce((s, i) => s + (i.unitPrice * i.qty || 0), 0);

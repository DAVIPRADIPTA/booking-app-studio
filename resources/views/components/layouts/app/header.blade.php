...
<head>
    ...
    <!-- Pastikan tidak ada dark mode -->
    <script>
        // Hapus class dark dari root (html/body)
        if (document.documentElement.classList.contains('dark')) {
            document.documentElement.classList.remove('dark');
        }
        // Atur localStorage agar tidak ingat mode gelap
...
<body class="min-h-screen bg-white">
    ...
    <!-- Script: Paksa Light Mode -->
    <script>
        // Pastikan mode selalu terang
        document.documentElement.classList.remove('dark');
